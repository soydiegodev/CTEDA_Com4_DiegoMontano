...
//			res.Add(lfalse_rows);
			...
			// ** se modifico esto para que los rows false esten a la izquierda, 
			// para que a la hora de crear el arbol los nodos que esten como hijos izquierdos correspondan a las "valores" falsos
			res.Add(lfalse_rows);
			res.Add(ltrue_rows);
